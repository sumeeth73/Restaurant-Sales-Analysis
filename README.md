...
Graphs - For Sales, Items, Cuisines, Branch, Mode
Slicers - For Search
...
When the data grows the Dashboard has a capability to refresh and show the correct figures.
 
#### 6. Future Scope
We will be adding features for filtering for a period of time and making more user friendly.

#### 7. Snapshot of the Dashboard
1[Dashboard Preview] [https://github.com/sumeeth73/Restaurant-Sales-Analysis/blob/main/Snapshot%20of%20RSA%20Dashboard.png]
